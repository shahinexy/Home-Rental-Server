...
const createLandlordIntoDb = (payload, userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield prisma_1.default.$transaction((prisma) => __awaiter(void 0, void 0, void 0, function* () {
        // create Landlord
        const createAgecy = yield prisma.landlord.create({
            data: Object.assign(Object.assign({}, payload), { userType: "Landlord", userId }),
        });
        // update user
...
const getLandlordsFromDb = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.landlord.findMany({
        include: {
            user: {
                select: {
                    id: true,
